...
import GiovanniLongo.entities.PersonaSesso;
...
//        ped.save(persona1);
//        ped.save(persona2);
//        Evento evento1 = new Evento("Evento 1", LocalDate.of(2023, 12, 31), "Concerto di capodanno", EventType.PUBBLICO, 1000, 1);
//        Evento evento2 = new Evento("Evento 2", LocalDate.of(2023, 12, 25), "Concerto di natale", EventType.PUBBLICO, 1000, 1);
//        Evento evento3 = new Evento("Evento 3", LocalDate.of(2023, 12, 31), "Concerto di capodanno", EventType.PRIVATO, 1000, 2);
//
//        ed.save(evento1);
//        ed.save(evento2);
//        ed.save(evento3);
